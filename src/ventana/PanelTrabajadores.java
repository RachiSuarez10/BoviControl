...
public class PanelTrabajadores extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jButton3.setText("Registrar trabajador");
        ...
        jButton5.setText("Modificar trabajador");
        ...
        jPanel1.add(panelTrabajador, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 30, 900, 410));

        add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 899, -1));
    }// </editor-fold>//GEN-END:initComponents

    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        AgregarTrabajador agregarTrabajador = new AgregarTrabajador();
        showPanel(agregarTrabajador);
    }//GEN-LAST:event_jButton3ActionPerformed

    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        BuscarTrabajador buscarTrabajador = new BuscarTrabajador();
        showPanel(buscarTrabajador);
    }//GEN-LAST:event_jButton4ActionPerformed

    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ModificarTraajador modificarTraajador =new ModificarTraajador();
        showPanel(modificarTraajador);
    }//GEN-LAST:event_jButton5ActionPerformed

    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        EliminarTrabajador eliminarTrabajador = new EliminarTrabajador();
        showPanel(eliminarTrabajador);
    }//GEN-LAST:event_jButton6ActionPerformed

    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        Tablatrabajadores tablatrabajadores = new Tablatrabajadores();
        showPanel(tablatrabajadores);
    }//GEN-LAST:event_jButton7ActionPerformed
     private void showPanel(JPanel p) {
        
        p.setSize(898, 440);
        p.setLocation(0, 0);
        panelTrabajador.removeAll();
        panelTrabajador.add(p, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, -1, -1));
        panelTrabajador.revalidate();
        panelTrabajador.repaint();
    }

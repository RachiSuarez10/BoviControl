...
public class PanelVentas extends javax.swing.JPanel {
   ...
   private void showPanel(JPanel p) {
        ...
        p.setSize(898, 440);
        p.setLocation(0, 0);
        panelVenta.removeAll();
        panelVenta.add(p, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, -1, -1));
        panelVenta.revalidate();
        panelVenta.repaint();
    }

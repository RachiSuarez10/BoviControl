 ...
 * @author suare
 */
public class TablaBovinos extends javax.swing.JPanel {

    /**
     * Creates new form TablaBovinos
     */
    ...
    public TablaBovinos() {
        ...
        try {
            ...
            PreparedStatement pst = cn.prepareStatement(
                    "select username, no_arete,fecha_nac_bov,raza,estadobov from bovinos inner join usuarios using(idusuarios)");
    ...
    private void initComponents() {
        ...
        JtableBovinos.setSelectionBackground(new java.awt.Color(255, 255, 255));
        jScrollPane1.setViewportView(JtableBovinos);
